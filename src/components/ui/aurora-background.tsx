      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            after:animate-aurora after:[background-attachment:fixed] dark:after:mix-blend-difference
            pointer-events-none
            absolute -inset-[10px] opacity-60 dark:opacity-100 will-change-transform`,
